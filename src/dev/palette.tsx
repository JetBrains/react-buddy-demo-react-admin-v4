...
export default () => (
  <Palette>
    <Category name="App configuration">
      <Component
        name="Admin"
        docURL="https://marmelab.com/react-admin/Admin.html"
      >
        <Variant>
          <Admin>
            <Resource
      ...
      <Component
        name="CustomRoutes"
        docURL="https://marmelab.com/react-admin/CustomRoutes.html"
      >
        <Variant>
          <CustomRoutes>
            <Route path="/path1" />
    ...
    <Category name="List">
      ...
      <Component
        name="InfiniteList"
        docURL="https://marmelab.com/react-admin/InfiniteList.html"
      >
        <Variant>
          <InfiniteList>
            <Datagrid>
    ...
    <Category name="Fields">
      ...
      >
        ...
        <Variant name="perPage">
          <ArrayField source="sourceName" perPage={5}>
            <Datagrid>
              <TextField source="sourceName" />
            </Datagrid>
            <Pagination />
      ...
      >
        ...
        <Variant name="purifyOptions">
          <RichTextField
            source="sourceName"
            purifyOptions={{ ADD_ATTR: ["target"] }}
          />
        </Variant>
      </Component>
      <Component
